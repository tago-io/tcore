import { IDatabaseDeviceDataEdit, TDeviceType, TGenericID } from "@tago-io/tcore-sdk/types";
import { getDeviceConnection } from "../../Helpers/DeviceDatabase";

/**
 * Edits a device data point.
 */
async function editDeviceData(deviceID: TGenericID, type: TDeviceType, data: IDatabaseDeviceDataEdit[]): Promise<void> {
