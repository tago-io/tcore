            ...
            configs: [
              {
                ...
                tooltip: "The host name or IP address of the Postgres server",
                name: "Host",
                icon: "hdd",
                required: true,
              },
              {
                ...
                defaultValue: 5432,
                tooltip:
                  "The TCP/IP port on which the Postgres server is listening (the default is 5432)",
                name: "Port",
                icon: "network-wired",
                required: true,
              },
            ...
            configs: [
              {
                ...
                defaultValue: "localhost",
                tooltip:
                  "The host name or IP address of the read instance of the Postgres server",
                name: "Read host",
                icon: "hdd",
                required: true,
              },
              {
                ...
                field: `${prefix}_read_port`,
                tooltip:
                  "The TCP/IP port on which the read instance of the Postgres server is listening (the default is 5432)",
                placeholder: "5432",
                defaultValue: 5432,
                name: "Port",
                icon: "network-wired",
            ...
            configs: [
              {
                ...
                defaultValue: "localhost",
                tooltip:
                  "The host name or IP address of the write instance of the Postgres server",
                name: "Write host",
                icon: "hdd",
              },
              {
                ...
                tooltip:
                  "The TCP/IP port on which the write instance of the Postgres server is listening (the default is 5432)",
                placeholder: "5432",
                defaultValue: 5432,
                name: "Port",
                icon: "network-wired",
...
const settings: Configs = [
  {
    ...
    tooltip:
      "If you enable this option, Data from devices will be stored in a different Postgres connection.",
    defaultValue: false,
  },
  {
    type: "group",
  ...
  div,
  {
    ...
    configs: [
      connection("device"),
      {
        ...
        placeholder:
          "The name of the database that will store data from devices",
        icon: "database",
